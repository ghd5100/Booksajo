  ...
  .star span {
	...
	<div class="tab_detail_content" id="infotab"
		...
		<table class="bookReviewTable">
			...
			<tbody>
				<tr>
					<th scope="col" class="user_id">아이디</th>
					<th scope="col" class="re_date">날 짜</th>
					<th scope="col" class="re_score">평점</th>
					<th scope="col" class="re_score">답변</th>
...
<!-- 이선아 교환/반품/품절 테이블 -->
		...
		<div class="box_detail_content">
			<a name="boxDetailTag" style="position: relative; top: -300px"></a>
